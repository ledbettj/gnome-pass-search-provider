...
arch=('any')
url="https://github.com/ledbettj/gnome-pass-search-provider"
license=('GPL')
depends=('python-gobject' 'python-dbus' 'python-rapidfuzz')
optdepends=('gpaste' 'pass' 'rbw' 'gopass')
makedepends=('git')
provides=($_pkgname)
conflicts=($_pkgname)
source=('gnome-pass-search-provider::git+https://github.com/ledbettj/gnome-pass-search-provider.git')
md5sums=('SKIP')
